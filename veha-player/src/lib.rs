...
/// Run the player. Initialises the output sink, starts the IPC command
/// listener, and enters the frame render loop. Does not return until
/// the output window is closed or the process is killed.
